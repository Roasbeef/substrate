...
// =============================================================================
// TaskStore implementation for SqlcStore using raw SQL
// =============================================================================

// scanTaskList scans a row into a TaskList struct.
func scanTaskList(row interface{ Scan(...any) error }) (TaskList, error) {
	var tl TaskList
	var lastSyncedAt sql.NullInt64
	var createdAt int64

	err := row.Scan(
		&tl.ID, &tl.ListID, &tl.AgentID, &tl.WatchPath,
...
func scanTask(row interface{ Scan(...any) error }) (Task, error) {
	var t Task
	var description, activeForm, metadata, owner, blockedBy, blocks sql.NullString
	...
	err := row.Scan(
		&t.ID, &t.AgentID, &t.ListID, &t.ClaudeTaskID, &t.Subject,
		&description, &activeForm, &metadata, &t.Status, &owner,
		&blockedBy, &blocks, &createdAt, &updatedAt,
		&startedAt, &completedAt, &filePath, &fileMtime,
	)
	if err != nil {
		return Task{}, err
	}
	...
	t.Blocks = blocks.String
	t.CreatedAt = time.Unix(createdAt, 0)
	t.UpdatedAt = time.Unix(updatedAt, 0)
	t.FilePath = filePath.String
	t.FileMtime = fileMtime.Int64

	if startedAt.Valid {
		st := time.Unix(startedAt.Int64, 0)
		t.StartedAt = &st
	}
...
func (s *SqlcStore) CreateTaskList(ctx context.Context,
...
func (s *SqlcStore) GetTaskList(ctx context.Context,
	listID string,
) (TaskList, error) {
	row := s.sqlDB.QueryRowContext(ctx, `
...
func (s *SqlcStore) GetTaskListByID(ctx context.Context,
	id int64,
) (TaskList, error) {
	row := s.sqlDB.QueryRowContext(ctx, `
		SELECT id, list_id, agent_id, watch_path, created_at, last_synced_at
...
func (s *SqlcStore) ListTaskLists(ctx context.Context) ([]TaskList, error) {
...
func (s *SqlcStore) ListTaskListsByAgent(ctx context.Context,
	agentID int64,
) ([]TaskList, error) {
	rows, err := s.sqlDB.QueryContext(ctx, `
		SELECT id, list_id, agent_id, watch_path, created_at, last_synced_at
...
func (s *SqlcStore) UpdateTaskListSyncTime(ctx context.Context,
...
func (s *SqlcStore) DeleteTaskList(ctx context.Context,
	listID string,
) error {
	_, err := s.sqlDB.ExecContext(ctx,
...
func (s *SqlcStore) CreateTask(ctx context.Context,
...
func (s *SqlcStore) UpsertTask(ctx context.Context,
...
func (s *SqlcStore) GetTask(ctx context.Context, id int64) (Task, error) {
	row := s.sqlDB.QueryRowContext(ctx, `
...
func (s *SqlcStore) GetTaskByClaudeID(ctx context.Context,
...
// listTasksWithQuery is a helper for task listing queries.
func (s *SqlcStore) listTasksWithQuery(ctx context.Context,
...
func (s *SqlcStore) ListTasksByAgent(ctx context.Context,
	agentID int64,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
			description, active_form, metadata, status, owner,
			blocked_by, blocks, created_at, updated_at,
			started_at, completed_at, file_path, file_mtime
...
func (s *SqlcStore) ListTasksByAgentWithLimit(ctx context.Context,
...
func (s *SqlcStore) ListActiveTasksByAgent(ctx context.Context,
	agentID int64,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
...
func (s *SqlcStore) ListTasksByList(ctx context.Context,
	listID string,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
...
func (s *SqlcStore) ListInProgressTasks(ctx context.Context,
	agentID int64,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
...
func (s *SqlcStore) ListPendingTasks(ctx context.Context,
	agentID int64,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
...
func (s *SqlcStore) ListBlockedTasks(ctx context.Context,
	agentID int64,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
...
func (s *SqlcStore) ListAvailableTasks(ctx context.Context,
	agentID int64,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
...
func (s *SqlcStore) ListRecentCompletedTasks(ctx context.Context,
...
func (s *SqlcStore) ListAllTasks(ctx context.Context,
	limit, offset int,
) ([]Task, error) {
	return s.listTasksWithQuery(ctx, `
		SELECT id, agent_id, list_id, claude_task_id, subject,
...
func (s *SqlcStore) ListTasksByStatus(ctx context.Context,
...
func (s *SqlcStore) UpdateTaskStatus(ctx context.Context,
...
func (s *SqlcStore) UpdateTaskOwner(ctx context.Context,
...
func (s *SqlcStore) GetTaskStatsByAgent(ctx context.Context,
...
func (s *SqlcStore) GetTaskStatsByList(ctx context.Context,
...
func (s *SqlcStore) GetAllTaskStats(ctx context.Context,
...
func (s *SqlcStore) GetAllAgentTaskStats(ctx context.Context,
	todaySince time.Time,
...
func (s *SqlcStore) CountTasksByList(ctx context.Context,
	listID string,
) (int64, error) {
	var count int64
...
func (s *SqlcStore) DeleteTask(ctx context.Context, id int64) error {
	_, err := s.sqlDB.ExecContext(ctx,
...
func (s *SqlcStore) DeleteTasksByList(ctx context.Context,
	listID string,
) error {
	_, err := s.sqlDB.ExecContext(ctx,
...
func (s *SqlcStore) MarkTasksDeletedByList(ctx context.Context,
	listID string, activeIDs []string, now time.Time,
) error {
	if len(activeIDs) == 0 {
		// No active IDs means mark all as deleted.
		_, err := s.sqlDB.ExecContext(ctx, `
			UPDATE agent_tasks
...
func (s *SqlcStore) PruneOldTasks(ctx context.Context,
	olderThan time.Time,
) error {
	_, err := s.sqlDB.ExecContext(ctx, `
