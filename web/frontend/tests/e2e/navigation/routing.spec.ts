...
test.describe('Mobile navigation', () => {
  test.skip('hamburger menu appears on mobile', async ({ page }) => {
    // Skip: Mobile navigation may not be implemented yet.
    await setupAPIs(page);
  ...
  test.skip('clicking hamburger opens mobile menu', async ({ page }) => {
    // Skip: Mobile navigation may not be implemented yet.
    await setupAPIs(page);
    await page.setViewportSize({ width: 375, height: 667 });
    await page.goto('/');
  ...
  test.skip('mobile navigation links work', async ({ page }) => {
    // Skip: Mobile navigation may not be implemented yet.
    await setupAPIs(page);
    await page.setViewportSize({ width: 375, height: 667 });
    await page.goto('/');
