...
function modeColorClass(mode: CommentMode): string {
  switch (mode) {
    case 'comment':
      return 'text-[var(--c-steel)] bg-[#33608D]/8 border-[#33608D]/20';
    case 'replace':
      return 'text-[var(--c-amber)] bg-[#C98A1B]/8 border-[#C98A1B]/25';
    case 'insert':
      return 'text-[var(--c-green)] bg-[#178A5B]/8 border-[#178A5B]/20';
  }
}
...
export function CommentPopover({
  ...
  return createPortal(
    <div
      ref={popoverRef}
      className="fixed z-[110] w-80 rounded-lg border border-[var(--c-hair)] bg-[var(--c-card)] shadow-xl"
      style={{
        top: `${top}px`,
        left: `${left}px`,
    ...
    >
      ...
      <div className="p-3">
        ...
        {contextText && mode === 'comment' && (
          <div className="mb-2 rounded border border-[var(--c-fill)] bg-[var(--c-hover)] px-2 py-1.5 text-xs text-[var(--c-mut)]">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              onClick={onClose}
              className="rounded-md px-3 py-1.5 text-xs font-medium text-[var(--c-mut)] hover:bg-[var(--c-fill)]"
            >
              Cancel
            </button>
            <button
              ...
              disabled={text.trim() === ''}
              className="rounded-md bg-[var(--c-ink)] px-3 py-1.5 text-xs font-medium text-white hover:bg-[var(--c-inkhover)] disabled:cursor-not-allowed disabled:opacity-50"
            >
              Submit
            </button>
          </div>
