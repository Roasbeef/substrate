...
export function ThreadView({
  ...
  return (
    ...
    >
      {/* Toolbar. */}
      <div className="flex flex-shrink-0 items-center justify-between border-b border-[#E6E4DD] bg-[#F7F6F3] px-4 py-2">
        <div className="flex items-center gap-1">
          <button
            ...
            className={cn(
              ...
              'text-sm font-medium text-[#22262A]',
          ...
          <div className="mx-3 h-5 w-px bg-[#E6E4DD]" />
        ...
        <div className="flex items-center gap-1">
          ...
          />
          <div className="ml-2 h-5 w-px bg-[#E6E4DD]" />
          <ToolbarButton
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-md p-1.5 text-[#9BA0A6] hover:bg-[#F1EFE9] hover:text-[#22262A] focus:outline-none focus:ring-2 focus:ring-[#22262A]/30"
            aria-label="Close"
          >
      ...
      >
        {isLoading ? (
          ...
          <div className="flex h-full flex-col items-center justify-center text-center">
            ...
            <p className="mt-2 text-[#6B7280]">{error.message}</p>
          </div>
        ) : thread ? (
          <div className="space-y-4">
            {/* Subject. */}
            <h1 className="text-xl font-bold text-[#22262A]">{thread.subject}</h1>
